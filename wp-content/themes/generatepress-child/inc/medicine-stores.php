...
// сторінка medicine stores (список аптек, пагінація)
function medicine_stores_shortcode()
{
    ob_start();
    ...
    if ($stores->have_posts()) :
        ...
        echo '<div class="medicine-stores-grid">';
        echo '<ul class="medicine-stores-list">';
                        ...
                        <?php if ($address) : ?>
                            ...
                            <div class="adress">
                                ...
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.75 7.5C15.75 12.75 9 17.25 9 17.25C9 17.25 2.25 12.75 2.25 7.5C2.25 5.70979 2.96116 3.9929 4.22703 2.72703C5.4929 1.46116 7.20979 0.75 9 0.75C10.7902 0.75 12.5071 1.46116 13.773 2.72703C15.0388 3.9929 15.75 5.70979 15.75 7.5Z" stroke="#59B17A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M9 9.75C10.2426 9.75 11.25 8.74264 11.25 7.5C11.25 6.25736 10.2426 5.25 9 5.25C7.75736 5.25 6.75 6.25736 6.75 7.5C6.75 8.74264 7.75736 9.75 9 9.75Z" stroke="#59B17A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                ...
                                <a
                                    ...
                                    aria-label="<?php echo esc_attr__('Open store location in Google Maps', 'generatepress'); ?>">
                        ...
                        <?php if ($phone) : ?>
                            ...
                            <div class="phone">
                                ...
                                <a
                                    ...
                                    aria-label="<?php echo esc_attr__('Call store', 'generatepress'); ?>">
                ...
                <div class="card-bottom">
                    ...
                    <?php if ($website) : ?>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="<?php echo esc_attr__('Visit store website', 'generatepress'); ?>">
                            <?php esc_html_e('Visit Store', 'generatepress'); ?>
                        </a>
...
<?php
        ...
        if ($stores->max_num_pages > 1) :

            echo '<nav class="medicine-pagination" aria-label="' . esc_attr__('Stores pagination', 'generatepress') . '">';
            echo '<ul>';
            ...
            echo '<a class="pagination-arrow" href="' .
                esc_url(get_pagenum_link(max(1, $paged - 1))) .
                '" aria-label="' .
        ...
        echo '<p>';
        esc_html_e('No medicine stores found.', 'generatepress');
        echo '</p>';
    endif;
